...
#include "RollaBall/BasePlayer.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	ROLLABALL_API UClass* Z_Construct_UClass_ABasePlayer_NoRegister();
	ROLLABALL_API UClass* Z_Construct_UClass_ABasePlayer();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABasePlayer_Statics::NewProp_MovementForce = { "MovementForce", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABasePlayer, MovementForce), METADATA_PARAMS(Z_Construct_UClass_ABasePlayer_Statics::NewProp_MovementForce_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABasePlayer_Statics::NewProp_MovementForce_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ABasePlayer, 1754237866);
	template<> ROLLABALL_API UClass* StaticClass<ABasePlayer>()
	{
		return ABasePlayer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABasePlayer(Z_Construct_UClass_ABasePlayer, &ABasePlayer::StaticClass, TEXT("/Script/RollaBall"), TEXT("ABasePlayer"), false, nullptr, nullptr, nullptr);
